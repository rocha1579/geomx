...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function animateOnScroll() {
      const elements = document.querySelectorAll('.section-header, .sobre-text, .sobre-image, .servico-card, .tab-image, .tab-text, .cliente-logo, .depoimento, .contato-form, .contato-info, .footer-logo, .footer-column, .reveal');
